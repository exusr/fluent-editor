...
FluentImage _$FluentImageFromJson(Map<String, dynamic> json) =>
    FluentImage(json['src'] as String)
      ..id = json['id'] as String
      ..styles = (json['styles'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList()
...
Map<String, dynamic> _$ParagraphToJson(Paragraph instance) => <String, dynamic>{
  ...
  'fragments': instance.fragments
      .map(const FNodeJsonConverter().toJson)
      .toList(),
  'textAlign': instance.textAlign,
...
Link _$LinkFromJson(Map<String, dynamic> json) =>
    Link(url: json['url'] as String, text: json['text'] as String?)
      ..id = json['id'] as String
      ..fragments = (json['fragments'] as List<dynamic>)
          .map(
            (e) =>
...
FluentList _$FluentListFromJson(Map<String, dynamic> json) =>
    FluentList(listType: json['listType'] as String)
      ..id = json['id'] as String
      ..fragments = (json['fragments'] as List<dynamic>)
          .map(
            (e) =>
...
Map<String, dynamic> _$ListItemToJson(ListItem instance) => <String, dynamic>{
  ...
  'children': instance.children.map(const FNodeJsonConverter().toJson).toList(),
  'fragments': instance.fragments.map(const FNodeJsonConverter().toJson).toList(),
  'text': instance.text,
};
